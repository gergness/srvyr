...
# Create favicon and put it in docs (requires image magick)
system(
  "convert dev-misc/ico-16.png dev-misc/ico-32.png dev-misc/ico-48.png dev-misc/ico-64.png docs/favicon.ico"
)
