...
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/srvyr)](http://cran.r-project.org/web/packages/srvyr) 
...
Conduct](CODE_OF_CONDUCT.md), as all participants are required to abide by its
terms.
...
post](https://www.tidyverse.org/articles/2017/08/contributing/) or Hadley
